...
//        pTexCoord.flip();
        ...
        Matrix.setRotateM(mMvpMatrix,0,270f,0f,0f,1f);
...
//        GLES20.glUniformMatrix4fv(muTexMatrixLoc, 1, false, mMvpMatrix, 0);
    ...
    public static int loadShader(final String vss, final String fss) {
        ...
        if (compiled[0] == 0) {
            if (DEBUG) L.e(TAG, "Failed to compile vertex shader:"
        ...
        if (compiled[0] == 0) {
            if (DEBUG) L.e(TAG, "Failed to compile fragment shader:"
